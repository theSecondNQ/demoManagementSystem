...
template <> constexpr inline auto mainmenu::qt_create_metaobjectdata<qt_meta_tag_ZN8mainmenuE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_bt_del_clicked",
        "on_bt_src_clicked",
        "on_bt_switch_clicked",
        "on_bt_showall_clicked",
        "on_bt_logsrc_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_bt_save_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_add_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_del_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_src_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_switch_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_showall_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_bt_logsrc_clicked'
...
void mainmenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_bt_save_clicked(); break;
        case 1: _t->on_bt_add_clicked(); break;
        case 2: _t->on_bt_del_clicked(); break;
        case 3: _t->on_bt_src_clicked(); break;
        case 4: _t->on_bt_switch_clicked(); break;
        case 5: _t->on_bt_showall_clicked(); break;
        case 6: _t->on_bt_logsrc_clicked(); break;
        default: ;
        }
    }
    (void)_a;
